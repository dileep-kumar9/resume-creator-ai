                      ...
                      <div key={project.id} className="page-break-inside-avoid">
                        ...
                        {(project.liveUrl || project.githubUrl) && (
                          <div className="text-xs space-x-4">
                            {project.liveUrl && (
                              <span>
                                <strong>Live:</strong> <a href={normalizeUrl(project.liveUrl)} target="_blank" rel="noreferrer" className="underline">{project.liveUrl}</a>
                              </span>
                            )}
                            {project.githubUrl && (
                              <span>
                                <strong>Code:</strong> <a href={normalizeUrl(project.githubUrl)} target="_blank" rel="noreferrer" className="underline">{project.githubUrl}</a>
                              </span>
                            )}
                          </div>
                        )}
