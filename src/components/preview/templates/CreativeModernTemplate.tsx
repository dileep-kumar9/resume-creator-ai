          ...
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-sm opacity-90">
            ...
            {personalInfo.website && (
              <div className="flex items-center gap-1">
                ...
                <a href={normalizeUrl(personalInfo.website)} target="_blank" rel="noreferrer" className="hover:underline text-white">Portfolio</a>
              </div>
            )}
            {personalInfo.linkedin && (
              <div className="flex items-center gap-1">
                <Linkedin className="w-3 h-3" />
                <a href={normalizeUrl(personalInfo.linkedin)} target="_blank" rel="noreferrer" className="hover:underline text-white">LinkedIn</a>
              </div>
            )}
          </div>
        </div>
