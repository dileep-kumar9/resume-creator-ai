          ...
          <div className="flex justify-center flex-wrap gap-x-4 gap-y-1 text-xs mt-1">
            {personalInfo.website && (
              <div className="flex items-center gap-1">
                ...
                <a href={normalizeUrl(personalInfo.website)} target="_blank" rel="noreferrer" className="hover:underline">Portfolio</a>
              </div>
            )}
                    ...
                    <div key={project.id}>
                      ...
                      {(project.liveUrl || project.githubUrl) && (
                        <div className="text-xs">
                          {project.liveUrl && <div><strong>Live:</strong> {project.liveUrl && <a href={normalizeUrl(project.liveUrl)} target="_blank" rel="noreferrer" className="underline">{project.liveUrl}</a>}</div>}
                          {project.githubUrl && <div><strong>Repository:</strong> {project.githubUrl && <a href={normalizeUrl(project.githubUrl)} target="_blank" rel="noreferrer" className="underline">{project.githubUrl}</a>}</div>}
                        </div>
                      )}
                    </div>
                  ))}
