                ...
                <tr>
                  ...
                  <td className="p-2 border align-top" style={{ borderColor: colors.secondary }}>
                    <div className="space-y-1">
                      ...
                      {project.liveUrl && (
                        <div><span className="font-medium">Project Link:</span> {project.liveUrl && <a href={normalizeUrl(project.liveUrl)} target="_blank" rel="noreferrer" className="underline">{project.liveUrl}</a>}</div>
                      )}
                    </div>
                  </td>
                  <td className="p-2 border align-top" style={{ borderColor: colors.secondary }}>
